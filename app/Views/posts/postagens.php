...
<div class="ui container">
    ...
    <div class="ui stackable grid">
        ...
        <div class="five wide column">
            ...
            <div class="ui basic segment" style="background-color: #FAFAFA;">
                ...
                <div class="ui basic segment">
                    ...
                    <button class="fluid ui olive button"> Ver lista completa</button>
                </div>
            ...
            <div class="ui basic segment" style="background-color: #FAFAFA;">
                ...
                <div class="ui middle aligned list">
                    <div class="item">
                        <img class="ui avatar image" src="../public/img/avatar3.jpg">
                        <div class="content">
                            <a class="header">Daniel Louise</a>
                        </div>
                    </div>
                    <div class="item">
                        <img class="ui avatar image" src="../public/img/avatar1.png">
                        <div class="content">
                            <a class="header">Stevie Feliciano</a>
                        </div>
                    </div>
                    <div class="item">
                        <img class="ui avatar image" src="../public/img/avatar2.png">
                        <div class="content">
